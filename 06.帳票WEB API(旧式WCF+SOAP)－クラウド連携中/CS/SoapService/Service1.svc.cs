...
namespace WCFServiceWebRole1
{
    ...
    public class Service1 : IService1
    {
        ...
        SqlConnection sqlcon = new SqlConnection("Server=tcp:fzxu46e9ck.database.windows.net,1433;Initial Catalog=Reports.net.Sample;Persist Security Info=False;User ID=login_user;Password=$Abc123$;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        ...
        public byte[] getReports単純なサンプル()
        {
            ...
            paoRep.Write("Text2", "これはローカルの ASP.NET C#で作った\n印刷データですよ～ん♪");
            paoRep.PageEnd();
        ...
        {
            //インスタンスの生成
            IReport paoRep = ReportCreator.GetImagePdf();
