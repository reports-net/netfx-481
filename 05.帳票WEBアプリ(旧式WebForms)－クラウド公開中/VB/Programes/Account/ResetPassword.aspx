<%@ Page Title="パスワードの再設定" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.vb" Inherits="Reports.net.Sample.WebSite.ResetPassword" Async="true" %>
